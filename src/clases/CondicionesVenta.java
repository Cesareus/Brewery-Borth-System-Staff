...
public class CondicionesVenta extends JFrame implements ActionListener{
...
String nombre="";
 ...
 try {
        ...
        PreparedStatement pst= cn.prepareStatement("update opciones set condicionesv=?where ID = 1");
